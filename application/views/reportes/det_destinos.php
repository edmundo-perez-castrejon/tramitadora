...
<div class="content">
<?php
  foreach($clientes_contrato as $c){
    $cve_cte = $c['CLAVE_CLIENTE'];
    ?>
    <H3><?php echo $cve_cte.' - '.$c['NOMBRE_CLIENTE']; ?></H3>
    <table border=1 width="100%" style="font-size: 15px; text-align: right">
    <tr>
    ...
    foreach($datos_destinos as $destino){
      if($destino['CLIENTE_DESTINO'] == $cve_cte AND $destino['ORDENADO'] > 0){
